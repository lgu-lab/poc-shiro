...
public class FakeRealm2 extends AuthorizingRealm {
	...
	private final static String REALM_NAME = "FakeRealm2";
	
	private final Logger logger = LoggerFactory.getLogger(FakeRealm2.class);
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
		...
		**/
		...
		if ( password.toUpperCase().equals("GO") ) {
			// Authentication OK
